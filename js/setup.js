...
var closePopup = function () {
  ...
  wizardCoat.removeEventListener('click', changeElementColor);
  wizardEyes.removeEventListener('click', changeElementColor);
  wizardFireball.removeEventListener('click', changeElementColor);
};
